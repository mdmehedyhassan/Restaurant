            ...
            <div className="container">
                <div className="mt-5 mb-5">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            ...
                            <h3 style={{color: '#eb6434', fontWeight: 700}}>+880 1870 289 584</h3>
                        </div>
                    </div>
                </div>
                <div className="row align-items-center mt-5 mb-5">
                    <div className="col-md-7">
                        ...
                        <button className="btn btn-outline-danger form-control mt-2 mb-2">SEND THE MESSAGE</button>
                    </div>
                    <div className="col-md-5 img-wrapper">
                        <img className="w-100 inner-img" style={{ borderRadius: 10 }} src={coverImg6} alt="" />
                    </div>
                </div>
            </div>
        </div>
