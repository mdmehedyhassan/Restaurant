                        ...
                        <div className="row">
                            <div className="col-md-6 mt-2">
                                <div style={{ borderBottom: '1px solid #8080804b', margin: '10px 0', padding: '10px 0' }} className="row align-items-center">
                                    ...
                                    <div className="col-8">
                                        <h3 className="fw-bolder">SOUPS</h3>
                            ...
                            <div className="col-md-6 mt-2">
                                <div style={{ borderBottom: '1px solid #8080804b', margin: '10px 0', padding: '10px 0' }} className="row align-items-center">
                                    ...
                                    <div className="col-8">
                                        <h3 className="fw-bolder">DUMPLINGS</h3>
                                        <p>Lorem ipsum dolor</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-md-6 mt-2">
                                <div style={{ borderBottom: '1px solid #8080804b', margin: '10px 0', padding: '10px 0' }} className="row align-items-center">
                                    ...
                                    <div className="col-8">
                                        <h3 className="fw-bolder">SPRING ROLLS</h3>
                                        <p>Lorem ipsum dolor</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-6 mt-2">
                                <div style={{ borderBottom: '1px solid #8080804b', margin: '10px 0', padding: '10px 0' }} className="row align-items-center">
                                    ...
                                    <div className="col-8">
                                        <h3 className="fw-bolder">DIM SUM</h3>
                                        <p>Lorem ipsum dolor</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-md-6 mt-2">
                                <div style={{ borderBottom: '1px solid #8080804b', margin: '10px 0', padding: '10px 0' }} className="row align-items-center">
                                    ...
                                    <div className="col-8">
                                        <h3 className="fw-bolder">NOODLES</h3>
                                        <p>Lorem ipsum dolor</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-6 mt-2">
                                <div style={{ borderBottom: '1px solid #8080804b', margin: '10px 0', padding: '10px 0' }} className="row align-items-center">
                                    <div className="col-4">
                                        <img className="w-100" src={icon6} alt="" />
                                    </div>
                                    <div className="col-8">
                                        <h3 className="fw-bolder">RICE</h3>
                                        <p>Lorem ipsum dolor</p>
                                    </div>
                                </div>
                            </div>
